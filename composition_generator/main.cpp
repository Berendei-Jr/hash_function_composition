...
err = clEnqueueWriteBuffer(queue, buf_v4_size, CL_TRUE, 0,
                                size_data.size() * sizeof(cl_uint), size_data.data(),
                                0, nullptr, nullptr);clSetKernelArg(kernel_md5, 0, sizeof(cl_mem), &buf_v4);
clSetKernelArg(kernel_md5, 1, sizeof(cl_mem), &buf_v4_size);
clSetKernelArg(kernel_md5, 2, sizeof(cl_mem), &buf_v0);
clSetKernelArg(kernel_md5, 3, sizeof(cl_mem), &buf_v0_size);
clEnqueueNDRangeKernel(queue, kernel_md5, 1, nullptr, &global_size, nullptr, 0, nullptr, nullptr);clSetKernelArg(kernel_sha512, 0, sizeof(cl_mem), &buf_v4);
...
clEnqueueNDRangeKernel(queue, kernel_sha512, 1, nullptr, &global_size, nullptr, 0, nullptr, nullptr);clSetKernelArg(kernel_xor, 0, sizeof(cl_mem), &buf_v0);
